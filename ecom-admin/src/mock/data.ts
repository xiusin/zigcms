...
// 响应格式化
export const success = (data: any, msg = 'success'): MockResponse => ({
  code: 200,
  msg,
  data,
});

export const pageSuccess = (list: any[], page = 1, pageSize = 10): MockResponse => ({
  code: 200,
  msg: 'success',
  data: {
    list,
...
> = {
  ...
  '/api/system/role/list': pageSuccess(
    Array.from({ length: 10 }, (_, i) => ({
      ...
      role_key: `role_${i + 1}`,
      description: '角色描述',
      menu_names: ['系统管理', '用户管理', '角色管理', '订单管理'],
      menu_ids: [1, 2, 3, 4],
        ...
        children: [
          {
            ...
            menu_type: 2,
            path: '/auto-test/task',
            component: '@/views/auto-test/task/list/index.vue',
            sort: 1,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            menu_type: 2,
            path: '/auto-test/case',
            component: '@/views/auto-test/case/list/index.vue',
            sort: 2,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            menu_type: 2,
            path: '/auto-test/bug',
            component: '@/views/auto-test/bug/list/index.vue',
            sort: 3,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            menu_type: 2,
            path: '/auto-test/execution',
            component: '@/views/auto-test/execution/list/index.vue',
            sort: 4,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            component: '@/views/auto-test/report/list/index.vue',
            sort: 5,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            icon: 'icon-robot',
            menu_type: 2,
            path: '/auto-test/ai-generate',
            component: '@/views/auto-test/ai-generate/index.vue',
            sort: 6,
            is_hide: 0,
            is_cache: 0,
            status: 1,
          ...
          },
          {
            ...
            icon: 'icon-folder',
            menu_type: 2,
            path: '/auto-test/suite',
            component: '@/views/auto-test/suite/list/index.vue',
            sort: 7,
            is_hide: 0,
            is_cache: 0,
            status: 1,
