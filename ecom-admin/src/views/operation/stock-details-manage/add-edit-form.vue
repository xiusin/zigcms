  ...
  >
    ...
    <template #footer>
      <a-space>
        ...
        <a-button
          v-if="!thisFormData.canOverWright"
          size="small"
          type="primary"
          @click="sendInfo"
        >
        ...
        <a-button v-else size="small" type="primary" @click="editInfoFn">
          保存
        </a-button>
      </a-space>
    </template>
...
<script lang="ts" setup>
  ...
  import OutConsignmentForm from '@/views/operation/stock-details-manage/out-consignment-form.vue';
  ...
  const editInfoFn = () => {
    outConsignmentFormRef.value.editInfo();
  };
