export default {
  'login.form.title': 'Login to Ecom',
  'login.form.userName.errMsg': 'Username, Email Or Phone cannot be empty',
  'login.form.password.errMsg': 'Password cannot be empty',
  'login.form.login.errMsg': 'Login error, refresh and try again',
  'login.form.login.success': 'welcome to use',
  'login.form.userName.placeholder': 'Username, Email Or Phone',
