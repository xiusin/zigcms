layui.define(["jquery", "layer", "laypage"], function (exports) {
  ...
  Class.prototype.updatePathBar = function () {
    ...
    fm.dirRoot.map(function (item, index, arr) {
      ...
      let html =
        ...
        icon +
        '"></i>' +
        '<a style="cursor: pointer;" data-path="' +
        item.path +
        '" data-index="' +
        index +
        '" data-name="' +
    ...
    that.layPathBar.off("click");
    that.layPathBar.on("click", "a[data-path]", function (e) {
      e.stopPropagation();
      const index = $(e.currentTarget).data("index");
      fm.dirRoot = fm.dirRoot.slice(0, index + 1);
      that.updatePathBar();
      return false;
    });
  };
  ...
  Class.prototype.events = function () {
    ...
    that.layToolBar.on("click", "#uploadfile", function () {
      ...
      layui.event.call(this, "fileManager", eventType + "(" + filter + ")", {
        obj: othis,
