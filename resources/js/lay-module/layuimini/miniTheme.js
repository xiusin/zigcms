    ...
    var miniTheme = {
        ...
        buildThemeCss: function (bgcolorId) {
            ...
            var styleHtml =
                ...
                "    color:  " +
                bgcolorData.headerRightColor +
                ";\n" +
                "}\n" +
                "/**头部右侧下拉字体颜色 headerRightChildColor */\n" +
                ".layui-layout-admin .layui-header .layui-nav .layui-nav-item .layui-nav-child a {\n" +
                "    color:  " +
                bgcolorData.headerRightChildColor +
                "!important;\n" +
                "}\n" +
                "\n" +
                ...
                "    color: " +
                bgcolorData.headerRightColorThis +
                " !important;\n" +
                "}\n" +
                "\n" +
                ...
                "    border-top-color: " +
                bgcolorData.headerRightNavMore +
                " !important;\n" +
                "}\n" +
                "\n" +
                "/*头部右侧更多下拉颜色 headerRightNavMore */\n" +
                ...
                "    background-color: " +
                bgcolorData.headerRightNavMoreBg +
                " !important;\n" +
                "    color:" +
                bgcolorData.headerRightNavMoreColor +
                " !important;\n" +
                "}\n" +
                "\n" +
                ...
                "    color: " +
                bgcolorData.headerRightToolColor +
                ";\n" +
                "}\n" +
                "\n" +
        ...
        buildBgColorHtml: function (options) {
            ...
            $.each(bgColorConfig, function (key, val) {
                ...
                html +=
                    ...
                    val.leftMenuBg +
                    ';"></span><span style="display:block; width: 80%; float: left; height: 40px; background: #ffffff;"></span></div>\n' +
                    "</a>\n" +
                    "</li>";
            });
            return html;
        ...
        buildElemStyleHtml(options) {
            ...
            $.each(listElemStyle, function (key, val) {
                ...
                if (val.className === elemStyleName) {
                    html +=
                        '<li class="layui-this style-item" data-select-style="' +
                        val.className +
                        '" data-default-color-config="' +
                        val.defaultColorConfig +
                        '">\n';
                } else {
                    html +=
                        '<li class="style-item"  data-select-style="' +
                        val.className +
                        '" data-default-color-config="' +
                        val.defaultColorConfig +
                        '">\n';
