...
const jwt = @import("../modules/jwt.zig");
...
pub fn register(self: *Self, req: zap.Request) !void {
    ...
    if (req.body) |body| {
        dto = services.json.JSON.decode(dtos.User.Register, self.allocator, body) catch |e| return base.send_error(req, e);
    }
...
pub fn login(self: *Self, req: zap.Request) !void {
    ...
    if (req.body) |body| {
        dto = services.json.JSON.decode(dtos.User.Login, self.allocator, body) catch |e| return base.send_error(req, e);
    }
